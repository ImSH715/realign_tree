...
#SBATCH --job-name=dino_bin_shared
...
#SBATCH --output=logs/dino_bin_shared_%j.out
#SBATCH --error=logs/dino_bin_shared_%j.err
...
ensure_output_link "binary_dino_shared_ortho_rgb_balanced_cuda"
ensure_output_link "phase2_classifier_binary_dino_shared_ortho_rgb_balanced_cuda"

PHASE1_DIR="./outputs/phase1_dino_ssl_shared_ortho"
if [ -f "$PHASE1_DIR/phase1_encoder_best.pth" ]; then
  ...
  echo "Run run_dino_ssl_shared_ortho.sh first."
  exit 1
fi
...
TRAIN_OUT="./outputs/binary_dino_shared_ortho_rgb_balanced_cuda"
EVAL_OUT="./outputs/phase2_classifier_binary_dino_shared_ortho_rgb_balanced_cuda"
...
echo "============================================================"
echo "Step 1: Fine-tuning binary classifier from shared-orthomosaic DINO encoder"
echo "============================================================"
...
echo "============================================================"
echo "Step 2: Evaluating shared-orthomosaic DINO binary classifier"
echo "============================================================"

...
#SBATCH --job-name=dino_binary_bal
...
#SBATCH --output=logs/dino_binary_bal_%j.out
#SBATCH --error=logs/dino_binary_bal_%j.err
...
ensure_output_link "binary_dino_rgb_balanced_cuda"
ensure_output_link "phase2_classifier_binary_dino_rgb_balanced_cuda"

PHASE1_DIR="./outputs/phase1_dino_ssl_large"
if [ -f "$PHASE1_DIR/phase1_encoder_best.pth" ]; then
  ...
  echo "Run run_dino_ssl_large.sh first, or point PHASE1_DIR at an existing DINO checkpoint."
  exit 1
fi
...
TRAIN_OUT="./outputs/binary_dino_rgb_balanced_cuda"
EVAL_OUT="./outputs/phase2_classifier_binary_dino_rgb_balanced_cuda"
...
echo "============================================================"
echo "Step 1: Fine-tuning binary classifier from DINOv2 SSL encoder"
echo "============================================================"
...
echo "============================================================"
echo "Step 2: Evaluating DINO binary classifier"
echo "============================================================"

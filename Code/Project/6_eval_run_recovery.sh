...
python evaluate_pipeline.py \
  ...
  --output_csv "./outputs/evaluation/recovery_5m_refined.csv" \
...
python eval_direct_gt.py \
  --input_csv "./outputs/evaluation/recovery_5m_refined.csv" \
  --output_csv "./outputs/evaluation/recovery_5m_refined_evaluated.csv"

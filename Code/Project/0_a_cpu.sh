...
#SBATCH --job-name=21_resnet50
#SBATCH --mem=82G
#SBATCH --cpus-per-task=8
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --time=90:00:00
#SBATCH --output=logs/phase_1_5/21_resnet50_%j.out
#SBATCH --error=logs/phase_1_5/21_resnet50_%j.err
...
python train_supervised_encoder.py \
  ...
  --output_dir "./outputs/phase1_5_resnet50_23" \
  --label_field Tree \
  --folder_field Folder \
  --file_field File \
  --fx_field fx \

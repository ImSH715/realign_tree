...
#SBATCH --job-name=binary_lejepa
#SBATCH --mem=82G
#SBATCH --cpus-per-task=8
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --time=90:00:00
#SBATCH --output=logs/phase1/lejepa_binary_%j.out
#SBATCH --error=logs/phase1/lejepa_binary_%j.err
...
python train_supervised_encoder.py \
  ...
  --output_dir "./outputs/binary_lejepa" \

...
#SBATCH --job-name=resnet50_mil_20m
...
#SBATCH --output=logs/mil/resnet50/phase2/resnet50_mil_20m_%j.out
#SBATCH --error=logs/mil/resnet50/phase2/resnet50_mil_20m_%j.err
...
OUT_NAME="${OUT_NAME:-mil_resnet50_shared_seasonal_20m_${TRAIN_IMAGE_MODE}${RUN_TAG}_cuda}"
...
elif [ -f "./outputs/binary_resnet50_shared_seasonal_rgb_balanced_cuda_80ep/phase1_encoder_best.pth" ]; then
  INIT_ENCODER_CKPT="./outputs/binary_resnet50_shared_seasonal_rgb_balanced_cuda_80ep/phase1_encoder_best.pth"
elif [ -f "./outputs/binary_resnet50_shared_seasonal_rgb_balanced_cuda/phase1_encoder_best.pth" ]; then
  INIT_ENCODER_CKPT="./outputs/binary_resnet50_shared_seasonal_rgb_balanced_cuda/phase1_encoder_best.pth"
elif [ -f "./outputs/binary_resnet50_rgb_balanced_cuda/phase1_encoder_best.pth" ]; then
  INIT_ENCODER_CKPT="./outputs/binary_resnet50_rgb_balanced_cuda/phase1_encoder_best.pth"
elif [ -f "./outputs/phase1_resnet50_cpu/phase1_encoder_best.pth" ]; then
  INIT_ENCODER_CKPT="./outputs/phase1_resnet50_cpu/phase1_encoder_best.pth"
else
  echo "Could not find an init ResNet50 encoder checkpoint."
  echo "Set INIT_CKPT explicitly, or run seasonal ResNet50 binary first."
  exit 1
fi

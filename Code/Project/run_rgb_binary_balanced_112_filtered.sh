...
#SBATCH --job-name=rgb_bin112_filt
...
#SBATCH --output=logs/rgb_bin112_filt_%j.out
#SBATCH --error=logs/rgb_bin112_filt_%j.err
...
TRAIN_OUT="./outputs/binary_resnet50_rgb_balanced_112_filtered_cuda"
EVAL_OUT="./outputs/phase2_classifier_binary_rgb_balanced_112_filtered_cuda"
...
echo "============================================================"
echo "Step 1: Training RGB 112px binary classifier with quality filtering"
echo "============================================================"
...
echo "============================================================"
echo "Step 2: Evaluating RGB 112px classifier"
echo "============================================================"
